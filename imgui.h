...
struct ImGuiIO
{
    ...
    ImVec2      FocusPos;                           // brentfpage: Used in implot/implot.cpp to set the point on the plot whose position is constant while the user is zooming using a pinch gesture on mobile
